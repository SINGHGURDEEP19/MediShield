...
filepath = '/Users/gurdeepsingh/Downloads/AgriCare-Detect-master/model.h5'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
      ...
      return "Healthy and Fresh", 'Healthy.html'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('/Users/gurdeepsingh/Downloads/AgriCare-Detect-master/static/upload', filename)
        file.save(file_path)
